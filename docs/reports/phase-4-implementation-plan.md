...
export const businesses = mysqlTable("businesses", {
  ...
  claimStatus: mysqlEnum("claimStatus", ["UNCLAIMED","PENDING","CLAIMED","REJECTED"])
...
export const vendorsMeta = mysqlTable("vendors_meta", {
  ...
  subscriptionStatus: mysqlEnum("subscriptionStatus", ["ACTIVE","PAST_DUE","CANCELED","NONE"])
...
export const products = mysqlTable("products", {
  ...
  kind: mysqlEnum("kind", ["PHYSICAL","DIGITAL","SERVICE"]).default("PHYSICAL").notNull(),
  fulfillment: mysqlEnum("fulfillment", ["PICKUP","DELIVERY","DIGITAL"]).notNull(),
...
export const idxProductsBusiness = index("idx_products_business").on(products.businessId);
```
...
export const orders = mysqlTable("orders", {
  ...
  status: mysqlEnum("status", ["PENDING","PAID","REFUNDED","DISPUTED","FULFILLED","CLOSED"])
...
export const refundRequests = mysqlTable("refund_requests", {
  ...
  buyerEmail: varchar("buyerEmail", { length: 320 }).notNull(),
  reason: text("reason"),
  status: mysqlEnum("status", ["OPEN","VENDOR_DECIDED","CLOSED"]).default("OPEN").notNull(),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  decidedAt: timestamp("decidedAt"),
});
```
...
export const disputeLog = mysqlTable("dispute_log", {
  ...
  status: mysqlEnum("status", ["OPEN","WON","LOST","CLOSED"]).default("OPEN").notNull(),
